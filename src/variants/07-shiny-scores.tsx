                    ...
                    {ranking.length === 0 ? (
                      ...
                      <TableRow key={r.kandidat.id} className="text-[13px] hover:bg-amber-50/30 transition-colors">
                        ...
                        <TableCell className="text-right">
                          <ShinyText text={fmtScore(r.avg)} speed={3} color={scoreFarbe(Math.round(r.avg)).includes("emerald") ? "#059669" : scoreFarbe(Math.round(r.avg)).includes("amber") ? "#d97706" : "#dc2626"} shineColor="#ffffff" className="tabular-nums text-lg font-bold" />
                        </TableCell>
