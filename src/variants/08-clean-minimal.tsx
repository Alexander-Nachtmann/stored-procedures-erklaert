    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-stone-100">
        <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
          <div>
            <h1>
              <span className="text-2xl font-bold tracking-tight text-stone-800">Interview-Protokoll</span>
            </h1>
            <p className="text-[13px] text-stone-400 mt-1">Stored Procedures — interaktiv erklärt</p>
          </div>
          <div className="flex gap-8">
            <div className="text-right">
              <p className="text-3xl font-bold tabular-nums text-stone-700"><span>{kandidaten.length}</span></p>
              <p className="text-[10px] text-stone-400 uppercase tracking-widest mt-0.5">Kandidaten</p>
            </div>
            <div className="text-right">
              <p className="text-3xl font-bold tabular-nums text-violet-500"><span>{bewertungen.length}</span></p>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="text-center mt-12 mb-6 space-y-2">
          <p className="text-sm font-medium text-stone-500">
            Du hast gerade 3 Stored Procedures benutzt.
          </p>
