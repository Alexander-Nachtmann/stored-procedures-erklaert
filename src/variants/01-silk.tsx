...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
      {/* -- Header with Silk background -- */}
      <header className="relative overflow-hidden bg-white/80 backdrop-blur-sm border-b border-stone-100">
        <div className="absolute inset-0 opacity-[0.17] pointer-events-none">
          <Silk speed={3} scale={0.8} color="#7D3BED" noiseIntensity={1.5} rotation={0} />
        </div>
